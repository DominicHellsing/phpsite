...
function CheckAuthentication()
{
	...
	if( (isset($_SESSION['AdminID']) && $_SESSION['AdminID'] ) || 
			(isset($_SESSION['MemberID']) && $_SESSION['MemberID'] ) ){
		return true;
	}else{
		return false;
	}
...
$baseUrl = substr($phpSelf, 0, stripos($phpSelf, 'public')).'Upload/';
/*
...
if( !isset($_SESSION['AdminID']) || $_SESSION['AdminID'] != 1 ){
	$config['AccessControl'][0]['folderCreate'] = false;
	$config['AccessControl'][0]['folderRename'] = false;
	$config['AccessControl'][0]['folderDelete'] = false;
	$config['AccessControl'][0]['fileRename'] = false;
	$config['AccessControl'][0]['fileDelete'] = false;
}
/*
...
$config['ResourceType'][] = Array(
		...
		'allowedExtensions' => $upload['UPLOAD_FILE_TYPE'],
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $upload['MAX_UPLOAD_SIZE'],
		'allowedExtensions' => $upload['UPLOAD_FILE_TYPE'],
		'deniedExtensions' => 'asp,aspx,jsp,php,ashx,js,html,htm');
